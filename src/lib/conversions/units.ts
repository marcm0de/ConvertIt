...
export const unitCategories: UnitCategory[] = [
  ...
  },
  {
    ...
    units: [
      ...
      { id: 'pb', label: 'Petabyte', factor: 8000000000000000 },
      { id: 'kib', label: 'Kibibyte', factor: 8192 },
      { id: 'mib', label: 'Mebibyte', factor: 8388608 },
      { id: 'gib', label: 'Gibibyte', factor: 8589934592 },
      { id: 'tib', label: 'Tebibyte', factor: 8796093022208 },
    ],
  },
  {
    name: 'Programming',
    units: [
      { id: 'prog-bit', label: 'Bit', factor: 1 },
      { id: 'prog-byte', label: 'Byte (B)', factor: 8 },
      { id: 'prog-word16', label: 'Word (16-bit)', factor: 16 },
      { id: 'prog-dword', label: 'DWord (32-bit)', factor: 32 },
      { id: 'prog-qword', label: 'QWord (64-bit)', factor: 64 },
      { id: 'prog-kb-bin', label: 'KiB (1024 B)', factor: 8192 },
      { id: 'prog-mb-bin', label: 'MiB (1024 KiB)', factor: 8388608 },
      { id: 'prog-gb-bin', label: 'GiB (1024 MiB)', factor: 8589934592 },
      { id: 'prog-kb-dec', label: 'KB (1000 B)', factor: 8000 },
      { id: 'prog-mb-dec', label: 'MB (1000 KB)', factor: 8000000 },
      { id: 'prog-gb-dec', label: 'GB (1000 MB)', factor: 8000000000 },
      { id: 'prog-page4k', label: 'Page (4 KiB)', factor: 32768 },
      { id: 'prog-sector', label: 'Sector (512 B)', factor: 4096 },
      { id: 'prog-block4k', label: 'Block (4 KiB)', factor: 32768 },
    ],
  },
];
